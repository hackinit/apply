...
angular.module('reg')
    ...
    .constant('DASHBOARD', {
        ...
        INCOMPLETE: '如果你在 [APP_DEADLINE] 前无法完成申请，你将无法被组委会审查参赛者资格。请尽快完成你的申请。',
        ...
        CLOSED_AND_INCOMPLETE: '由于你未及时完成信息填写，你无法被组委会审查参赛者资格',
        ADMITTED_AND_CAN_CONFIRM_TITLE: '请在 [CONFIRM_DEADLINE] 前确认参赛',
        ADMITTED_AND_CANNOT_CONFIRM_TITLE: '你的参赛者邀请已经失效',
        ADMITTED_AND_CANNOT_CONFIRM: '虽然我们为你提供了参赛者资格，但是你并没有在参赛者确认截止日期前确认。\n很遗憾，你的邀请已经提供给了等待名单上的其他申请者。\n希望在明年的活动宣传中见到你！',
        CONFIRMED_NOT_PAST_TITLE: '你可以在 [CONFIRM_DEADLINE] 前修改你的确认信息。',
        DECLINED: '很遗憾，我们今年无法邀请你参加我们的参赛者计划 :(\n希望在明年的活动中见到你！',
    })
    .constant('TEAM',{
